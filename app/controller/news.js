...
exports.list = function* newsListController() {
    ...
    // 像下面这种格式来调用业务逻辑的执行结果，这里是调用：`service/hackerNews.js`文件里的api
    ...
    yield this.render('news/list.tpl', {
        list: newsList,
        page,
        pageSize
    });
...
exports.detail = function* newsDetailController() {
    ...
    yield this.render('news/detail.tpl', {
        item: newsInfo,
...
exports.user = function* userInfoController() {
    ...
    yield this.render('news/user.tpl', {
        user: userInfo
    });
};
